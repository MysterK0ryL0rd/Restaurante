...
public class Factura3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.escaner3);
        ...
        toolbar.setSubtitle("Factura Camara");
        toolbar.setNavigationIcon(R.drawable.arrow_left);
        setSupportActionBar(toolbar);
        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Factura3.this, MainActivity.class);
        ...
        mButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (comprobarDatos() == true) {
                    final IntentIntegrator integrator = new IntentIntegrator(Factura3.this);
                    //integrator.putExtra("SCAN_MODE", "PRODUCT_MODE");
                    integrator.setCaptureLayout(R.layout.custom_capture_layout);
                    //Button cancel = (Button) v.findViewById(R.id.zxing_back_button);


                    integrator.initiateScan();
                } else {
                    Toast.makeText(Factura3.this, "Seleccione una Serie", Toast.LENGTH_SHORT).show();
                }
        ...
        escaner_btn_grabar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (laSerie.equals("")) {
                    Toast.makeText(Factura3.this, "Favor de elegir Serie ", Toast.LENGTH_LONG).show();

                } else if (elCliente.equals("") || elAgente.equals("")) {
                    Toast.makeText(Factura3.this, "Favor de elegir Cliente/Agente ", Toast.LENGTH_LONG).show();
                    ...
                    if (cantidad_articulos > 0) {
                        ...
                        Toast.makeText(Factura3.this, "Factura Vacia", Toast.LENGTH_LONG).show();
                    }
                }
            }
        });
    ...
    public static String POST3(String url) {
        ...
        entidad.put("codigoSKU", barcode); //nombreCorto
    ...
    private class HttpAsyncTask6 extends AsyncTask<String, Void, String> {
        ...
        protected void onPostExecute(String result) {
            ...
            if (comprobarDatos() == true && first_time == 0) {
                final IntentIntegrator integrator = new IntentIntegrator(Factura3.this);
                //integrator.putExtra("SCAN_MODE", "PRODUCT_MODE");
                integrator.setCaptureLayout(R.layout.custom_capture_layout);
                //Button cancel = (Button) v.findViewById(R.id.zxing_back_button);
        ...
        busclie_btn_aceptar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (tmp.get(0).length() <= 1 && tmp.get(1).length() <= 1 && tmp.get(2).length() <= 1 && tmp.get(3).length() <= 1) {
                    Toast.makeText(Factura3.this, "Favor de ingresar mayor caracteres", Toast.LENGTH_SHORT).show();
                } else {
    ...
    private void build_popup2() {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(Factura3.this);
    ...
    public void alertReferencias() {
        ...
        LayoutInflater inflater = Factura3.this.getLayoutInflater();
        ...
        cambio_btn_generar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (Double.parseDouble(cambio_etx_cambio.getText().toString()) >= Double.parseDouble(cambio_txv_total.getText().toString())) {
                    ...
                    AlertDialog.Builder dialog2 = new AlertDialog.Builder(Factura3.this);
                    ...
                    Toast.makeText(Factura3.this, "Cantidad menor al total", Toast.LENGTH_SHORT);
    ...
    public void onCheckboxClicked() {
        ...
        for (int i = 0; i < chbx_selected.size(); i++) {
            ...
            if (chbx_selected.get(i).isChecked()) {
                ...
                TableRow tr = new TableRow(Factura3.this);
                ...
                final EditText c00 = new EditText(Factura3.this);
                c00.setInputType(InputType.TYPE_CLASS_NUMBER);
                c00.setText("1");
                c00.setGravity(Gravity.CENTER);
            //    c00.setTextColor(Color.parseColor("#ffffff"));
    ...
    public void crearTablaArticulos2() {
        ...
        if (lista_art.isEmpty()) {
            TextView c1 = new TextView(Factura3.this);
            ...
            for (int j = 0; j < lista_art.size(); j++) {
                ...
                TableRow tr = new TableRow(Factura3.this);
                CheckBox c0 = new CheckBox(Factura3.this);
                c0.setId(R.id.select_art + j);
                chbx_selected.add(c0);

                TextView c1 = (TextView) Factura3.this.getLayoutInflater().inflate(R.layout.renglones, null);
                c1.setText(lista_art.get(j).getId().toString());

                TextView c2 = (TextView) Factura3.this.getLayoutInflater().inflate(R.layout.renglones2, null);
                c2.setText(lista_art.get(j).getDescripcion().toString());

                TextView c3 = (TextView) Factura3.this.getLayoutInflater().inflate(R.layout.renglones, null);
                c3.setText(lista_art.get(j).getExistencia().toString());

                TextView c4 = (TextView) Factura3.this.getLayoutInflater().inflate(R.layout.renglones2, null);
                c4.setText(lista_art.get(j).getNombre().toString());

                TextView c5 = (TextView) Factura3.this.getLayoutInflater().inflate(R.layout.renglones2, null);
                c5.setText(lista_art.get(j).getNombreCorto().toString());

                TextView c6 = (TextView) Factura3.this.getLayoutInflater().inflate(R.layout.renglones, null);
    ...
    private class HttpAsyncTask9 extends AsyncTask<String, Void, String> {
        ...
        protected void onPostExecute(String result) {
            ...
            Intent intent = new Intent(Factura3.this, Blue.class);
            ...
            if(pdfFile.exists())
            {
                ...
                {
                    Toast.makeText(Factura3.this, "No Application available to view txt", Toast.LENGTH_LONG).show();
                }
            }
    ...
    private class HttpAsyncTask10 extends AsyncTask<String, Void, String> {
        ...
        protected void onPostExecute(String result) {
            ...
            if(pdfFile.exists())
            {
                ...
                {
                    Toast.makeText(Factura3.this, "No Application available to view pdf", Toast.LENGTH_LONG).show();
                }
            }
    ...
    public String POST11(String url) {
        Map<String, Object> map2 = new HashMap();// 2980571970
        map2.put("id", id);
        map2.put("tipo", "facturacliente");
        map2.put("@class", Map.class.getName());
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.salir) {
            ...
            finish();
            pc.clear();
            Intent localIntent = new Intent(Factura3.this.getApplicationContext(), LogIn.class);
