...
public class MenuLineas3 extends Fragment {
            ...
            for(int i=0; i< (nombres.size()); i++) {
                ...
                c1.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View arg0) {
                        ...
                        /*Intent intent = new Intent(getContext(), MenuArticulosLineas.class);
                        intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                        intent.putExtra("idLinea", String.valueOf((Integer) mapa1.get("id")));
             ...
             /*   <LinearLayout
                ...
                android:background="#10b2a4"
                android:id="@+id/opc_factura">
