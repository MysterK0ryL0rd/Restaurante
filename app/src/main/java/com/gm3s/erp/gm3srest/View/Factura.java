...
public class Factura extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar.setSubtitle("Factura Escaner");
        toolbar.setNavigationIcon(R.drawable.arrow_left);
        setSupportActionBar(toolbar);
        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Factura.this, MainActivity.class);
        ...
        mButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (comprobarDatos() == true) {
                    ...
                    Toast.makeText(Factura.this, "Seleccione una Serie", Toast.LENGTH_SHORT).show();
                }
        ...
        escaner_btn_grabar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (laSerie.equals("")) {
                    Toast.makeText(Factura.this, "Favor de elegir Serie ", Toast.LENGTH_LONG).show();

                } else if (elCliente.equals("") || elAgente.equals("")) {
                    Toast.makeText(Factura.this, "Favor de elegir Cliente/Agente ", Toast.LENGTH_LONG).show();
                    ...
                    if (cantidad_articulos > 0) {
                        ...
                        Toast.makeText(Factura.this, "Factura Vacia", Toast.LENGTH_LONG).show();
                    }
                }
            }
        });
    ...
    public static String POST3(String url) {
        ...
        // entidad.put("nombreCorto", barcode); //nombreCorto
        if(et_escaner.getText().toString().contains("\n")){
            System.out.println("-->"+ et_escaner.getText().toString()+"<--");
            entidad.put("codigoSKU", et_escaner.getText().toString().substring(0, et_escaner.getText().toString().length()-1)); //nombreCorto
        }
        else{
            System.out.println("+++"+ et_escaner.getText().toString()+"+++");
            entidad.put("codigoSKU", et_escaner.getText().toString()); //nombreCorto
        }
    ...
    public void convertirDatosArticulo(String cadena) {
        Toast.makeText(getApplicationContext(), "convertirDatosArticulo", Toast.LENGTH_LONG).show();
        ...
        busclie_btn_aceptar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (tmp.get(0).length() <= 1 && tmp.get(1).length() <= 1 && tmp.get(2).length() <= 1 && tmp.get(3).length() <= 1) {
                    Toast.makeText(Factura.this, "Favor de ingresar mayor caracteres", Toast.LENGTH_SHORT).show();
                } else {
    ...
    private void build_popup2() {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(Factura.this);
    ...
    public void alertReferencias() {
        ...
        LayoutInflater inflater = Factura.this.getLayoutInflater();
        ...
        cambio_btn_generar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (Double.parseDouble(cambio_etx_cambio.getText().toString()) >= Double.parseDouble(cambio_txv_total.getText().toString())) {
                    ...
                    AlertDialog.Builder dialog2 = new AlertDialog.Builder(Factura.this);
                    ...
                    Toast.makeText(Factura.this, "Cantidad menor al total", Toast.LENGTH_SHORT);
    ...
    public void onCheckboxClicked() {
        ...
        for (int i = 0; i < chbx_selected.size(); i++) {
            ...
            if (chbx_selected.get(i).isChecked()) {
                ...
                TableRow tr = new TableRow(Factura.this);
                ...
                final EditText c00 = new EditText(Factura.this);
                c00.setInputType(InputType.TYPE_CLASS_NUMBER);
                c00.setText("1");
                c00.setGravity(Gravity.CENTER);
              //  c00.setTextColor(Color.parseColor("#ffffff"));
    ...
    public void convertirDatosArticulo2(String cadena) {
        Toast.makeText(getApplicationContext(), "convertirDatosArticulo2", Toast.LENGTH_LONG).show();
        ObjectMapper mapper = new ObjectMapper();
        try {
            lista_art.clear();
    ...
    public void crearTablaArticulos2() {
        ...
        if (lista_art.isEmpty()) {
            TextView c1 = new TextView(Factura.this);
            ...
            for (int j = 0; j < lista_art.size(); j++) {
                ...
                TableRow tr = new TableRow(Factura.this);
                CheckBox c0 = new CheckBox(Factura.this);
                c0.setId(R.id.select_art + j);
                chbx_selected.add(c0);

                TextView c1 = (TextView) Factura.this.getLayoutInflater().inflate(R.layout.renglones, null);
                c1.setText(lista_art.get(j).getId().toString());

                TextView c2 = (TextView) Factura.this.getLayoutInflater().inflate(R.layout.renglones2, null);
                c2.setText(lista_art.get(j).getDescripcion().toString());

                TextView c3 = (TextView) Factura.this.getLayoutInflater().inflate(R.layout.renglones, null);
                c3.setText(lista_art.get(j).getExistencia().toString());

                TextView c4 = (TextView) Factura.this.getLayoutInflater().inflate(R.layout.renglones2, null);
                c4.setText(lista_art.get(j).getNombre().toString());

                TextView c5 = (TextView) Factura.this.getLayoutInflater().inflate(R.layout.renglones2, null);
                c5.setText(lista_art.get(j).getNombreCorto().toString());

                TextView c6 = (TextView) Factura.this.getLayoutInflater().inflate(R.layout.renglones, null);
    ...
    private class HttpAsyncTask8 extends AsyncTask<String, Void, String> {
        ...
        protected void onPostExecute(String result) {
            ...
            System.out.println("Factura creada " + result);
    ...
    private void documentoPopUp(String id) {
        ...
        builder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                a.execute(server + "/medialuna/spring/documentos/tickets/ticketFacturaDefault/");
    ...
    public String createExternalStoragePrivateFile2(String cadena, String id, byte[] data, int inicio) {
        ...
        System.out.println("***************************************************************");
        System.out.println("***************************************************************");
        System.out.println(cadena.substring(0,100));
        System.out.println(cadena.substring(100,200));
        System.out.println(cadena.substring(300,400));
        System.out.println(cadena.substring(400));
        System.out.println("***************************************************************");
        System.out.println("***************************************************************");
...
/*        String resultado = "";
    ...
    private class HttpAsyncTask9 extends AsyncTask<String, Void, String> {
        ...
        protected void onPostExecute(String result) {
            ...
            Intent intent = new Intent(Factura.this, Blue.class);
            ...
            /*Toast.makeText(getApplicationContext(), "Ticket guardado como TF" + id +".txt", Toast.LENGTH_LONG).show();


            File pdfFile = new File("/storage/sdcard0/Download/TF"+id+".txt");
            if(pdfFile.exists())
            {
                ...
                {
                    Toast.makeText(Factura.this, "No Application available to view txt", Toast.LENGTH_LONG).show();
                }
            }
    ...
    private class HttpAsyncTask10 extends AsyncTask<String, Void, String> {
        ...
        @Override
        protected void onPostExecute(String result) {
            Toast.makeText(getApplicationContext(), "Factura Guardada como: F" + id + ".pdf", Toast.LENGTH_LONG).show();
            ...
            if(pdfFile.exists())
            {
                ...
                {
                    Toast.makeText(Factura.this, "No Application available to view pdf", Toast.LENGTH_LONG).show();
                }
            }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.salir) {
            ...
            finish();
            pc.clear();
            Intent localIntent = new Intent(Factura.this.getApplicationContext(), LogIn.class);
